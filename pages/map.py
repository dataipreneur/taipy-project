...
<|{data_province_displayed}|chart|type=scattermapbox|lat=lat|lon=lng|marker={marker_map}|layout={layout_map}|text=Text|mode=markers|height=800px|options={options}|>
"""
